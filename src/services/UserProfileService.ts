...
class UserProfileService {
  ...
  public async updateUserBio(
    ...
    if (!userBio) {
      throw new Errors.BadRequestError("Users Bio is Undefined", { userBio });
    }
    ...
    if (!user) {
      throw new Errors.ResourceNotFoundError("User does not exist", { userId });
    }
  }
  ...
  public async updateUsersFullName(
    ...
    if (!name) {
      throw new Errors.BadRequestError("Users Name is Undefined", { name });
    }
  ...
  public async fetchUserProfile(
    ...
    this.logger.logInfo("User fetched their profile", { userId, userProfile });
  ...
  public async followUser(
    ...
    if (user.following.includes(followeeId)) {
      throw new Errors.ConflictError("Follower is already following Followee", {
        followerId,
        followeeId,
    ...
    if (followee.followers.includes(followerId)) {
      throw new Errors.ConflictError("Followee already follows Follower", {
        followerId,
        followeeId,
